...
if os.path.exists(dfile):
    ...
    from AM2p5C360.data_TCgenesis_map_mclim import mclim as tc
...
if os.path.exists(dfile):
    ...
    from AM2p5C360.data_pTang_map_mclim import mclim as p
...
if os.path.exists(dfile):
    ...
    from AM2p5C360.data_seedgenesis_map_mclim_rainy import mclim as seed
