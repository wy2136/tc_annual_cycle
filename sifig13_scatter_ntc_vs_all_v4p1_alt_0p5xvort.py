...
if os.path.exists(dfile):
    ...
    from ERA5.fig_scatter_ntc_vs_all_rainy0p5xvort import get_scatter_data as get_scatter_data_era5
    from IBTrACS.data_ntc_cycle import get_cycle as cycle_ntc
    from amipHadISST.fig_scatter_ntc_vs_all_rainy0p5xvort import get_scatter_data as get_scatter_data_hiram
    from AM2p5.fig_scatter_ntc_vs_all_rainy0p5xvort import get_scatter_data as get_scatter_data_floram
    from AM2p5C360.fig_scatter_ntc_vs_all_rainy import get_scatter_data as get_scatter_data_floramplus
