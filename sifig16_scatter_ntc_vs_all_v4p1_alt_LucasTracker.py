...
if os.path.exists(dfile):
    ...
    from amipHadISST.fig_scatter_ntc_vs_all import get_scatter_data as get_scatter_data_hiram
    from AM2p5.fig_scatter_ntc_vs_all import get_scatter_data as get_scatter_data_floram
    from AM2p5C360.fig_scatter_ntc_vs_all import get_scatter_data as get_scatter_data_floramplus
